...
Route::group(['prefix'=>'admin'],function(){
    ...
    Route::group(['middleware' => ['user-permission:manage-catogery-level-1']], function () {
        ...
        Route::post('/CatOneAdd', [CatogeryController::class, 'catOneStore']);
        Route::get('/catOne/delete/{id}', [CatogeryController::class, 'catOnedelete']);
        Route::get('/catOne/edit/{id}', [CatogeryController::class, 'catOneEdit']);
    ...
    Route::group(['middleware' => ['user-permission:manage-catogery-level-3']], function () {
        ...
        Route::post('/CatThreeAdd', [CatogeryController::class, 'catThreeStore']);
        Route::get('/catThree/delete/{id}', [CatogeryController::class, 'catThreedelete']);
        Route::get('/catThree/edit/{id}', [CatogeryController::class, 'catThreeEdit']);
    ...
    Route::group(['middleware' => ['user-permission:manage-products']], function () {
        ...
        Route::get('/product/edit/{id}', [CatogeryController::class, 'productEdit']);
