                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="cart-product-image">
                                        <a href="product-details.html"><img src="{{$products->thumbnail}}" alt="#"></a>
                                    </td>
                                    <td class="cart-product-info">
                                        <h4><a href="product-details.html">{{$products->name}}</a></h4>
                                    </td>
                                    <td class="cart-product-price">{{$products->price}}</td>
                                    <td class="cart-product-quantity">
                                        <div class="cart-plus-minus">
                                            <input type="text" value="01" name="qtybutton" class="cart-plus-minus-box">
                                        </div>
                                    </td>
                                    <td class="cart-product-subtotal">{{$products->offer_price}}</td>
                                </tr>
                        ...
                        <table class="table">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><strong>${{$products->offer_price+15}}</strong></td>
                                </tr>
                            </tbody>
                        </table>
